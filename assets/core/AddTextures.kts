...
Textures add AnimatedTextureSprite(getArray("characters", "mouse_idle#1", "mouse_idle#1", "mouse_idle#1", "mouse_idle#1", "mouse_idle#2", "mouse_idle#3", "mouse_idle#4", "mouse_idle#5"), true, 0.25f, 0f, 1f)
Textures add AnimatedTextureSprite(getArray("characters", "mouse_walk#1", "mouse_walk#2", "mouse_walk#3", "mouse_walk#4"), true, 0.25f)
Textures add AnimatedTextureSprite(getArray("characters", "player_walk#1", "player_walk#2", "player_walk#3"), true, 0.25f)
...
Textures add AnimatedTextureSprite(getArray("characters", "player_idle#1", "player_idle#2"), true, 0.5f)
